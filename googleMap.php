...
<html>
  ...
  <body>
    ...
    Origin Latitude: <input type="text" id="oriLat" >
    Origin Longitude: <input type="text" id="oriLng" >
    Destination Latitude: <input type="text" id="destLat" >
    Destination Longitude: <input type="text" id="destLng" >
